...
public class ProfileViewModel : ViewModelBase
{
    ...
    private async Task UpdateProfileAsync()
    {
        ...
        if (_userService == null || _toastViewModel == null || _currentUserOriginal == null) { ShowToastMessage("Service or user data unavailable.", ToastType.Error); return; }
        IsUpdatingProfile = true; User userToUpdate = new User { Id = _currentUserOriginal.Id, Username = _currentUserOriginal.Username, Email = this.Email, Role = _currentUserOriginal.Role, FullName = this.FullName, Address = this.Address, IsActive = _currentUserOriginal.IsActive, PasswordHash = _currentUserOriginal.PasswordHash };
